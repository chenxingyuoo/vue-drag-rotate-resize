...
/**
 * 获取一个矩形的中心点
 * @param  {object} rect 矩形宽高对象
 * @return {object}      中心点坐标
 * @example
 * getRectCenter({width: 100, height: 100})
 ...
 * @example
 * getRect2CenterTranslate({width: 100, height: 100}, {width: 200, height: 200})
 * // => {left: 50, top: 50}
 */
export const getRect2CenterTranslate = (originRect, targetRect) => {
  const targetCenter = getRectCenter(targetRect)
  const originCenter = getRectCenter(originRect)
  return {
    top: targetCenter.centerY - originCenter.centerY,
    left: targetCenter.centerX - originCenter.centerX
  }
}
